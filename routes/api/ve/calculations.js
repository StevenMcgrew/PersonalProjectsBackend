...
// The following query string parameters are allowed:
...
router.post('', async (req, res, next) => {
    try {
        ...
        let pQuery = new PQ({
            text: `INSERT INTO calculations (year, make, model, engine, condition, comments, maf_units, temp_units, elevation_units, rpm, maf, air_temp, elevation, ve)
